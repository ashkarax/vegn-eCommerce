...
func (r *JWTUseCase) GetRestStatForAccessToken(restaurantId *int) (*string,error) {
	restaurantStat, err := r.JWTRepo.GetRestStatForGeneratingAccessToken(restaurantId)
	if err != nil {
		return restaurantStat, err
	}
	return restaurantStat, nil
}
